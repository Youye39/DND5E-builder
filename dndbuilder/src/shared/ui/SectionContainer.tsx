    ...
    <div className={`absolute bg-white rounded-[2px] ${className}`}>
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <div className="absolute bg-black bottom-0 h-[24px] overflow-clip w-full" data-name="边栏">
          <div
            className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-serif-bold-cjk font-bold justify-center leading-[0] left-0 right-0 text-[10px] text-center text-white top-[12px]"
