...
interface SkillComponentProps {
  ...
  onTotalModifierChange?: (modifier: number) => void;
}
...
export default function SkillComponent({
  ...
  modifier,
  proficiencyBonus = 0,
  onTotalModifierChange,
}: SkillComponentProps) {
  const [skillState, setSkillState] = useState<0 | 1 | 2>(0);
  ...
  useEffect(() => {
    onTotalModifierChange?.(totalModifier);
  }, [totalModifier, onTotalModifierChange]);
