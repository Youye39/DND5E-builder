  ...
  return (
    <div className={className || "bg-white h-[107px] relative rounded-[2px] w-[330px]"} data-name="个性特点">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <div className="absolute bg-sheet-content-bg bottom-[24px] h-[73px] left-[9px] overflow-clip w-[312px]">
          <textarea
            value={value}
            onChange={handleInputChange}
            className="absolute font-serif-regular-cjk font-normal h-[63px] leading-[normal] left-[5px] text-[16px] text-black top-[5px] w-[302px] bg-transparent border-none outline-none resize-none"
