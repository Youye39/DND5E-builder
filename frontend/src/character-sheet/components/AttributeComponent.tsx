  ...
  return (
    ...
    >
      <div className="absolute bg-white border-2 border-black border-solid inset-[0_0_10.4%_0] overflow-clip rounded-[4px] shadow-[0px_-1px_0px_0px_black,0px_1.5px_0px_0px_black]">
        <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Noto_Serif:Medium','Noto_Sans_CJK:Medium',sans-serif] font-medium h-[17px] justify-center leading-[0] left-[46px] text-[12px] text-black text-center top-[13.5px] w-[44px]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
          <p className="leading-[normal]">{label}</p>
        </div>
      </div>
      <div 
        className="absolute bg-[#efefef] inset-[23.2%_10.31%_32.8%_9.28%] overflow-visible flex items-center justify-center gap-2 group"
      >
        {/* 减按钮 */}
        <div
        ...
        <input
          ...
          className="flex-shrink-0 w-16 h-12 font-['Noto_Serif:Regular',sans-serif] font-normal text-[36px] text-black text-center bg-transparent border-none outline-none appearance-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
      ...
      <div className="absolute contents inset-[72%_23.71%_0_22.68%]">
        ...
        <div className="[word-break:break-word] absolute flex flex-col font-['Noto_Serif:Regular',sans-serif] font-normal inset-[72%_23.71%_0_22.68%] justify-center leading-[0] text-[15px] text-black text-center" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
