    ...
    <div className="h-[44px] relative w-[358px]" data-name="被动感知（察觉）" style={{ left: '-1px' }}>
      <div className="absolute bg-white inset-[2.27%_0] rounded-[2px]">
        <div className="overflow-clip relative rounded-[inherit] size-full">
          <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Noto_Serif:Medium','Noto_Sans_JP:Medium','Noto_Sans_SC:Medium',sans-serif] font-medium justify-center leading-[0] left-[207px] text-[12px] text-black text-center top-[21px] w-[316px]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
      ...
      <div className="absolute contents inset-[0_81.84%_0_1.68%]">
        ...
        <div className="absolute bg-[#efefef] inset-[18.18%_83.52%_18.18%_3.35%]" />
        <div className="[word-break:break-word] absolute flex flex-col font-['Noto_Serif:Regular',sans-serif] font-normal inset-[2.27%_81.84%_2.27%_1.68%] justify-center leading-[0] text-[21px] text-black text-center" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
